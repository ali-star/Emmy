...
public class DateConverter {
	...
	public static final long islamicToJdn(IslamicDate islamic) {
		...
		//Here Is The Event Problem !!!
		int day=0;
		if(islamic.getMonth()==1){
			day = islamic.getDayOfMonth()+1;
		}else{
			day = islamic.getDayOfMonth();
		}

		if(islamic.getMonth()==6 && islamic.getYear() == 1437){
			day = islamic.getDayOfMonth()+1;
		}

		/*if(islamic.getMonth()==6 && islamic.getYear() == 1436){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
			}
		}/*/

		/*if(islamic.getMonth()==7 && islamic.getYear() == 1436){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		/*if(islamic.getMonth()==8 && islamic.getYear() == 1436){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		/*if(islamic.getMonth()==11 && islamic.getYear() == 1436){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		/*if(islamic.getMonth()==9 && islamic.getYear() == 1436){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		if(islamic.getMonth()==4 && islamic.getYear() == 1437){
			try{
				day = islamic.getDayOfMonth()+1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		if(islamic.getMonth()==9 && islamic.getYear() == 1437){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		if(islamic.getMonth()==10 && islamic.getYear() == 1436){
			try{
				day = islamic.getDayOfMonth()+1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		if(islamic.getMonth()==10 && islamic.getYear() == 1437){
			try{
				day = islamic.getDayOfMonth()-1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		if(islamic.getMonth()==1 && islamic.getYear() == 1438){
			try{
				day = islamic.getDayOfMonth()+1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		if(islamic.getMonth()==5 && islamic.getYear() == 1438){
			try{
				day = islamic.getDayOfMonth()+1;
			}catch(Exception e){
				Log.d("ERR !", "ERRRRRRRRRR");
		...
		long k = month + year * 12 - NMONTHS; // number of months since 1/1/1405
	...
	/*public static final IslamicDate jdnToIslamic(long jd) {
        ...
        int month = civil.getMonth()-1;
        int day = civil.getDayOfMonth();

        boolean dayTest=true;  
        double[] iDate = kuwaiticalendar(dayTest, day, month, year);

        return new IslamicDate((int) iDate[7], (int) iDate[6], (int) iDate[5]);
    }*/

	public static final IslamicDate jdnToIslamic(long jd) {

		CivilDate civil = jdnToCivil(jd);
		/*double day = civil.getDayOfMonth()-1;
		double month = civil.getMonth();
		double year = civil.getYear();*/
		int day = civil.getDayOfMonth();
		...
		int month_cv = 1;
		if(month == 1)
			month_cv = Calendar.JANUARY;
		if(month == 2)
			month_cv = Calendar.FEBRUARY;
		if(month == 3)
			month_cv = Calendar.MARCH;
		if(month == 4)
			month_cv = Calendar.APRIL;
		if(month == 5)
			month_cv = Calendar.MAY;
		if(month == 6)
			month_cv = Calendar.JUNE;
		if(month == 7)
			month_cv = Calendar.JULY;
		if(month == 8)
			month_cv = Calendar.AUGUST;
		if(month == 9)
			month_cv = Calendar.SEPTEMBER;
		if(month == 10)
			month_cv = Calendar.OCTOBER;
		if(month == 11)
			month_cv = Calendar.NOVEMBER;
		if(month == 12)
			month_cv = Calendar.DECEMBER;
		long c = setDay(year, month, day);

		todayHijri = new LocalDate(todayIso.toDateTimeAtStartOfDay(),
				hijri);
		
		int todayHijriDay = todayHijri.getDayOfMonth();
		
		if(c>=setDay(2016, Calendar.JULY+1, 6)){
			todayHijri = new LocalDate(todayIso.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2016, Calendar.MAY+1, 8)){
			todayHijri = new LocalDate(todayIso.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2016, Calendar.JUNE+1, 6)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2016, Calendar.JUNE+1, 6)){
				todayHijriDay = 30;
		...
		if(c>=setDay(2016, Calendar.OCTOBER+1, 2)){
			todayHijri = new LocalDate(todayIso.toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2016, Calendar.NOVEMBER+1, 1)){
			todayHijri = new LocalDate(todayIso.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2016, Calendar.OCTOBER+1, 31)&&todayHijriDay==30){
				todayHijriDay = 29;
			}
			if(c==setDay(2016, Calendar.NOVEMBER+1, 1)&&todayHijriDay==30){
				todayHijriDay = 1;
			}
		}
		
		if(c>=setDay(2016, Calendar.NOVEMBER+1, 30)){
			todayHijri = new LocalDate(todayIso.toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2016, Calendar.NOVEMBER+1, 30)){
		...
		if(c>=setDay(2017, Calendar.JANUARY+1, 29)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2017, Calendar.JANUARY+1, 29)){
		...
		if(c==setDay(2017, Calendar.FEBRUARY+1, 1)){
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2017, Calendar.FEBRUARY+1, 28)){
			todayHijri = new LocalDate(todayIso.toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2017, Calendar.MARCH+1, 29)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2017, Calendar.MARCH+1, 29)){
		...
		if(c>=setDay(2017, Calendar.APRIL+1, 28)){
			todayHijri = new LocalDate(todayIso.toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2017, Calendar.AUGUST+1, 23)){
			todayHijri = new LocalDate(todayHijri.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2017, Calendar.SEPTEMBER+1, 21)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2017, Calendar.SEPTEMBER+1, 21)){
		...
		if(c>=setDay(2017, Calendar.OCTOBER+1, 21)){
			todayHijri = new LocalDate(todayHijri.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2017, Calendar.NOVEMBER+1, 19)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2017, Calendar.NOVEMBER+1, 19)){
		...
		if(c>=setDay(2018, Calendar.JANUARY+1, 18)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2018, Calendar.JANUARY+1, 18)){
		...
		if(c>=setDay(2018, Calendar.JUNE+1, 15)){
			todayHijri = new LocalDate(todayHijri.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2018, Calendar.JULY+1, 14)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2018, Calendar.JULY+1, 14)){
		...
		if(c>=setDay(2018, Calendar.AUGUST+1, 13)){
			todayHijri = new LocalDate(todayHijri.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2018, Calendar.SEPTEMBER+1, 11)){
			todayHijri = new LocalDate(todayHijri.plusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
		}
		
		if(c>=setDay(2019, Calendar.JANUARY+1, 7)){
			todayHijri = new LocalDate(todayHijri.minusDays(1).toDateTimeAtStartOfDay(),
					hijri);
			todayHijriDay = todayHijri.getDayOfMonth();
			if(c==setDay(2019, Calendar.JANUARY+1, 7)){
		...
		return new IslamicDate(todayHijri.getYear(), todayHijri.getMonthOfYear(), todayHijriDay);
	}
	
	private static long setDay(int y, int m, int d){
