package alistar.app.brain.anomalyDetection.anomaly;
...
import alistar.app.brain.anomalyDetection.statistics.OnlineNormalStatistics;
import alistar.app.brain.anomalyDetection.statistics.QuickMedians;
import alistar.app.brain.anomalyDetection.stl.STLDecomposition;
import alistar.app.brain.anomalyDetection.stl.STLResult;
...
//        Median median = new Median();
        ...
        if (numAnoms > 0) {
            ...
            Collections.sort(map, new PairKeyComparator());
    ...
    private int[] getOrder(double[] data) {
        ...
        Collections.sort(map, new PairValueComparator());
